...
const FR: Dict = {
  ...
  sm: {
    ...
    option15: "−29,99 € : j'accepte que le personnage dessiné (jamais la photo) soit conservé pour de futures créations.",
...
const EN: Dict = {
  ...
  sm: {
    ...
    option15: "−€29.99: I agree that the drawn character (never the photo) may be kept for future creations.",
...
const ES: Dict = {
  ...
  sm: {
    ...
    option15: "−29,99 €: acepto que el personaje dibujado (nunca la foto) se conserve para futuras creaciones.",
...
const DE: Dict = {
  ...
  sm: {
    ...
    option15: "−29,99 €: Ich bin einverstanden, dass die gezeichnete Figur (nie das Foto) für künftige Kreationen aufbewahrt wird.",
